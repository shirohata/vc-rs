...
The Rust crates statically linked into the plugin binary (and their full license
texts) are listed in [`THIRD-PARTY-LICENSES.md`](THIRD-PARTY-LICENSES.md),
generated by `cargo about generate` (see `crates/vc-vst3/about.toml`).
